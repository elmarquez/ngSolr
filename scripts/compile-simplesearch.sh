...
cat ../app/js/solr-ajax/app/documentSearch.js >> ../app/js/solr-ajax/simplesearch.js
cat ../app/js/solr-ajax/controllers/documentSearchResultsController.js >> ../app/js/solr-ajax/simplesearch.js
cat ../app/js/solr-ajax/controllers/SearchBoxController.js >> ../app/js/solr-ajax/simplesearch.js
