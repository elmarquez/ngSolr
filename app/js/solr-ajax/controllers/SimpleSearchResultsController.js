 ...
 */
function SimpleSearchResultsController($scope, $route, $routeParams, SolrSearchService, Utils) {
    ...
    $scope.init = function() {
        $scope.$on("$routeChangeSuccess",
            function() {
                $scope.testquery = ($routeParams.query || "?");
                $scope.testpage = ($routeParams.page || 0);
                // update the query
...
SimpleSearchResultsController.$inject = ['$scope','$route','$routeParams','SolrSearchService','Utils'];
